...
def pregunta_04():
    ...
    param_grid = {
        'mlpregressor__hidden_layer_sizes': [(n,) for n in range(1, 9)],  # De 1 a 8 neuronas en la capa oculta
        'mlpregressor__activation': ['relu'],  # Activación con la función `relu`
        'mlpregressor__learning_rate': ['adaptive'],  # Tasa de aprendizaje adaptativa
        'mlpregressor__momentum': [0.7, 0.8, 0.9],  # Momentum con valores de 0.7, 0.8 y 0.9
        'mlpregressor__learning_rate_init': [0.01, 0.05, 0.1],  # Tasa de aprendizaje inicial
        'mlpregressor__max_iter': [5000],  # Un máximo de 5000 iteraciones
        'mlpregressor__early_stopping': [True],  # Use parada temprana
    }
